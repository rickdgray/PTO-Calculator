...
namespace PtoCalculator
{
    class Program
    {
        static void Main()
        {
            ...
            var pto_savings_percentage = PTO_DAYS_NEEDED_FOR_WINTER_HOLIDAYS / PTO_DAYS_EARNED_PER_YEAR;
            var days_till_next_full_pto_day_accrual = 365 / PTO_DAYS_EARNED_PER_YEAR;
